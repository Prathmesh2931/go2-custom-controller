...
class ik_node : public rclcpp ::Node 
{
    ...
    private :
        ...
        Legangles ik(double x, double y, double z)
        {
            ...
            float hip = atan2(y, -z) - atan2(l0, sqrt(y*y + z*z - l0*l0)); // angle of hip joint, accounting for hip offset
            ...
            float thigh = atanf(x/z2d) - atanf(l2*sin(calf) /l1 + l2*cos(calf)); // angle of thigh joint (Target Direction - internal offset)
